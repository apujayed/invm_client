...
const AddForm = () => {
  ...
  const getUserData = (event) => {
    ...
    setLcsellstore({ ...lcsellstore, [name]: value });
  };
            ...
            <div className="box-body form-horizontal">
              ...
              <div id="divsup" className="form-group">
                ...
                <div id="divsup" className="form-group">
                  ...
                  <div className="col-sm-8">
                    <Select
                      onFocus={() => getLcpvehicle()}
                      ref={vehicleFocus}
                      onChange={(selectedOption) => {
                      
                        setLcsellstore({
                          ...lcsellstore,
                          v_no: selectedOption.value,
                        ...
                        selectProduct(selectedOption.value,lcsellstore.country);
